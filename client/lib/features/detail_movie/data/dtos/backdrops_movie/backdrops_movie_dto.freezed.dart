...
abstract class $BackdropMoviesDTOCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'file_path', defaultValue: '') String image,
      @JsonKey(name: 'width', defaultValue: 0) double width,
      @JsonKey(name: 'height', defaultValue: 0) double height,
      @JsonKey(name: 'aspect_ratio', defaultValue: 0) double aspectRatio});
}
...
class _$BackdropMoviesDTOImpl extends _BackdropMoviesDTO {
  _$BackdropMoviesDTOImpl(
      {@JsonKey(name: 'file_path', defaultValue: '') required this.image,
      @JsonKey(name: 'width', defaultValue: 0) required this.width,
...
abstract class _BackdropMoviesDTO extends BackdropMoviesDTO {
  factory _BackdropMoviesDTO(
      ...
      @JsonKey(name: 'width', defaultValue: 0) required final double width,
      @JsonKey(name: 'height', defaultValue: 0) required final double height,
      @JsonKey(name: 'aspect_ratio', defaultValue: 0)
