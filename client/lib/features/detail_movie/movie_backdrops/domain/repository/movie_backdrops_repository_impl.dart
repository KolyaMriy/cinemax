...
import 'package:client/features/detail_movie/movie_backdrops/domain/repository/movie_backdrops_repository.dart';
  ...
  Either<Failure, List<BackdropMoviesEntity>> getSavedBackdropsMovie({
    ...
    try {
      final savedBackdrops =
          _localDataSource.getSavedBackDropsMovie(idMovie: idMovie);
